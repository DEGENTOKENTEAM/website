                    ...
                    <main className="website flex flex-col">
                            ...
                            <InnerContainer className="flex flex-col gap-8 py-16 md:flex-row">
                                ...
                                <div className="flex flex-col gap-8">
                                    ...
                                    <p>
                                        ...
                                        lock-up periods and rewards. It supports various networks like Ethereum and
                                        Binance Smart Chain, and integrates NFTs to represent and trade staking rewards.
                                        Users can customize reward tokens, payout options, and design unique NFTs. This
                                        protocol is ideal for DeFi enthusiasts looking for innovative and profitable
                        ...
                        <OuterContainer className="bg-dapp-blue-800/30">
                            <InnerContainer className="flex flex-col gap-8 py-16 md:flex-row">
                                <div className="flex flex-col gap-8">
                                    ...
                                    <p>
                                        With STAKEX, you have the flexibility to inject multiple reward tokens,
                                        configure different payout options, and even design unique NFTs. This allows for
                                        a personalized staking experience that caters to different investment strategies
                        ...
                        <OuterContainer className="bg-dapp-blue-800/30">
                            <InnerContainer className="flex flex-col gap-8 py-16 md:flex-row">
                                ...
                                <div className="flex flex-col gap-8">
                                    <h2 className="font-title text-2xl font-bold">
                                        What can your token holders do with{' '}
                                        <span className="text-techGreen">STAKE</span>
                                        <span className="text-degenOrange">X</span>?
                                    </h2>
                                    <p>
                                        With STAKEX, you token holders can stake their tokens in various customizable
                                        pools, each offering different lock-up periods and rewards. They will also
                                        receive NFTs that represent their staking options. Additionally your token
                                        holders are able to trade the NFTs.
                                    </p>
                                </div>
                            </InnerContainer>
                        </OuterContainer>
