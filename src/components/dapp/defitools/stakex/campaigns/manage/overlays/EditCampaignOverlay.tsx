...
export const EditCampaignOverlay = ({
    formData,
    setFormData,
    rewardToken,
    isFormValid,
            ...
            <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-6 text-base">
                    <h3 className="flex flex-row items-center gap-3 text-xl">
                        <div className="font-title">Update Campaign</div>
                    ...
                    {isSuccess && (
                        <>
                            <div className="absolute -inset-2 flex flex-col items-center justify-center gap-4 rounded-xl bg-dapp-blue-600/90">
                                ...
                                <span>Successfully upated campaign</span>
                            </div>
                        </>
                    )}
                </div>
