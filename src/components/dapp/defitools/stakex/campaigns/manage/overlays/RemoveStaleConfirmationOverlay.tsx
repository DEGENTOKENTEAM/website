...
type RemoveStaleConfirmationOverlayProps = BaseOverlayProps & {
    onConfirm: () => void
    onCancel: () => void
    error?: any
    isLoading: boolean
...
export const RemoveStaleConfirmationOverlay = ({
    isOpen,
    onClose,
    onConfirm,
    onCancel,
    ...
    isPending,
    error,
}: RemoveStaleConfirmationOverlayProps) => {
        ...
        <BaseOverlay isOpen={isOpen} closeOnBackdropClick={false} onClose={() => {}}>
            {showSuccessMessage && (
                <div>
                    <div className="flex flex-col items-center gap-6 p-6 text-center text-base">
                        ...
                        <span className="font-bold">Successfully removed stale campaigns</span>
                    </div>
                    <Button
                        variant="primary"
                        onClick={onClose}
            ...
            {showContent && (
                <div className="flex flex-col gap-6">
                    <div className="text-3xl font-bold">Remove stale campaigns</div>
                    <div>
                        You&apos;re about to remove stale campaigns
                        <br />
                        <br />A stale campaign is a campaign that has finished, all rewards being claimed and no staker
                        being left in this campaign.
                    </div>
