            ...
            {showContent && (
                <div className="flex flex-col gap-6">
                    ...
                    <div>
                        ...
                        <br />
                        When you&apos;ve enabled the merging feature, then your stakers will be charged with the defined
                        percentage for merging their existing stakes. Are you sure you want to proceed?
                    </div>
