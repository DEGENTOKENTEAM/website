        ...
        <BaseOverlay isOpen={isOpen} closeOnBackdropClick={false} onClose={() => {}}>
                ...
                <div>
                    <div className="flex flex-col items-center gap-6 p-6 text-center text-base">
                        ...
                        <span className="font-bold">
                            Successfully {targetStatus ? 'enabled' : 'disabled'} the merging feature
                        </span>
                    </div>
                    <Button
                        variant="primary"
            ...
            {showContent && (
                <div className="flex flex-col gap-6">
                    ...
                    <div>
                        You&apos;re about to {targetStatus ? 'enable' : 'disable'} the merging feature in your protocol.{' '}
                        <br />
                        <br />
                        After this change, all stakers are allowed to merge their stakes that are from the same staking
                        pool. Are you sure you want to proceed?
                    </div>
