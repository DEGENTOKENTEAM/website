        ...
        <BaseOverlay isOpen={isOpen} closeOnBackdropClick={false} onClose={() => {}}>
            {showSuccessMessage && (
                <div>
                    <div className="flex flex-col items-center gap-6 p-6 text-center text-base">
                        ...
                        <span className="font-bold">Successfully updated your Tokens</span>
                    </div>
                    <Button
                        variant="primary"
                        onClick={onClose}
            ...
            {showContent && (
                <div className="flex flex-col gap-6">
                    ...
                    <div>
                        You&apos;re about to add a new Token to your STAKEX protocol. <br />
                        <br />
                        After this change, you will be able to distribute a new token to your stakers. Are you sure you
                        want to proceed?
                    </div>
