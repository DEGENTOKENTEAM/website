        ...
        <BaseOverlay isOpen={isOpen} closeOnBackdropClick={false} onClose={() => {}}>
            ...
            {showContent && (
                <div className="flex flex-col gap-6">
                    ...
                    <div>
                        You&apos;re about to change the upstaking fee of your STAKEX protocol. <br />
                        <br />
                        When you&apos;ve enabled the upstaking feature, then your stakers will be charged with the
                        defined percentage for upstaking their existing stakes. Are you sure you want to proceed?
                    </div>
