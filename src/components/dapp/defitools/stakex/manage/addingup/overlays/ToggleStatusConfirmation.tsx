...
type ToggleStatusConfirmationProps = BaseOverlayProps & {
    onConfirm: () => void
    onCancel: () => void
    error?: any
    isLoading: boolean
...
export const ToggleStatusConfirmation = ({
    isOpen,
    onClose,
    onConfirm,
    onCancel,
        ...
        <BaseOverlay isOpen={isOpen} closeOnBackdropClick={false} onClose={() => {}}>
                ...
                <div>
                    <div className="flex flex-col items-center gap-6 p-6 text-center text-base">
                        ...
                        <span className="font-bold">
                            Successfully {targetStatus ? 'enabled' : 'disabled'} the adding up feature
                        </span>
                    </div>
                    <Button
                        variant="primary"
            ...
            {showContent && (
                <div className="flex flex-col gap-6">
                    ...
                    <div>
                        You&apos;re about to {targetStatus ? 'enable' : 'disable'} the adding up feature in your
                        protocol. <br />
                        <br />
                        After this change, all stakers are allowed to stake additional tokens to their stakes. Their old
                        stake will be removed and a new stake is being generated with the desired lock period. Are you
