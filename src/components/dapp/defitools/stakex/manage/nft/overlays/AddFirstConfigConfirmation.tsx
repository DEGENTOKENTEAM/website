...
type AddFirstConfigConfirmationProps = BaseOverlayProps & {
    onConfirm: () => void
    onCancel: () => void
    error?: any
    isLoading: boolean
...
export const AddFirstConfigConfirmation = ({
    isOpen,
    onClose,
    onConfirm,
    onCancel,
    ...
    isPending,
    error,
}: AddFirstConfigConfirmationProps) => {
        ...
        <BaseOverlay isOpen={isOpen} closeOnBackdropClick={false} onClose={() => {}}>
            {showSuccessMessage && (
                <div>
                    <div className="flex flex-col items-center gap-6 p-6 text-center text-base">
                        ...
                        <span className="font-bold">Successfully updated your NFT Configuration</span>
                    </div>
                    <Button
                        variant="primary"
                        onClick={onClose}
            ...
            {showContent && (
                <div className="flex flex-col gap-6">
                    ...
                    <div>
                        You&apos;re about to update the NFT configuration in order to proceed with the initial setup of
                        your STAKEX protocol. <br />
                        <br />
                        After this change, you are able to enable and activate your protocol. Are you sure you want to
                        proceed?
                    </div>
