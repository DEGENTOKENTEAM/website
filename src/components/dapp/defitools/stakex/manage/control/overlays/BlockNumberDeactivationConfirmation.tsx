...
type BlockNumberDeactivationConfirmationProps = BaseOverlayProps & {
    onConfirm: () => void
    onCancel: () => void
    error?: any
    isLoading: boolean
...
export const BlockNumberDeactivationConfirmation = ({
    isOpen,
    onClose,
    onConfirm,
    onCancel,
    ...
    isPending,
    error,
}: BlockNumberDeactivationConfirmationProps) => {
        ...
        <BaseOverlay isOpen={isOpen} closeOnBackdropClick={false} onClose={() => {}}>
            ...
            {showContent && (
                <div className="flex flex-col gap-6">
                    ...
                    <div>
                        You&apos;re about to remove the starting block.
                        <br />
