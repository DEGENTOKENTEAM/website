...
type DisableProtocolConfirmationProps = BaseOverlayProps & {
    onConfirm: () => void
    onCancel: () => void
    error?: any
    isLoading: boolean
...
export const DisableProtocolConfirmation = ({
    isOpen,
    onClose,
    onConfirm,
    onCancel,
    ...
    isPending,
    error,
}: DisableProtocolConfirmationProps) => {
        ...
        <BaseOverlay isOpen={isOpen} closeOnBackdropClick={false} onClose={() => {}}>
            ...
            {showContent && (
                <div className="flex flex-col gap-6">
                    ...
                    <div>
                        You&apos;re about to change the status of your STAKEX protocol. <br />
                        <br />
                        After this change, your stakers will not be able to interact with the protocol anymore. Are you
