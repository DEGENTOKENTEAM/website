...
type CreateProtocolConfirmationProps = BaseOverlayProps & {
    onConfirm: () => void
    onCancel: () => void
    error?: any
    isLoading: boolean
...
export const CreateProtocolConfirmation = ({
    isOpen,
    onClose,
    onConfirm,
    onCancel,
    ...
    error,
    children,
}: CreateProtocolConfirmationProps) => {
                ...
                <div>
                    <div className="flex flex-col items-center gap-6 p-6 text-center text-base">
                        ...
                        <span className="text-center font-bold">
                            Successfully created your protocol. <br /> <br /> You will be automatically redirected to
                            the management area after closing this popup
                        </span>
                    </div>
                    <Button
                        variant="primary"
